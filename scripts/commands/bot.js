...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  const fallbackReplies = [
    ...
    "বট না বলে পারলে বস রাজ কে একটা gf দে?",
    "বস রাজও তোমাকে অনেক ভালোবাসে",
    "বস রাজ এর পক্ষ থেকে তোমাকে আই লাভ ইউ -😍💋💝",
    "ji বলো জান তোমার চিপায় উম্মা😘?",
    "আমাকে না ডেকে আমার বস রাজকে ডাকেন! link: https://www.facebook.com/61574869774986",
    "এই গুলো পাবনা থেকে ছারে কেন মানুষের নাম জানেনা আমার নাম বাবু😘😘",
    "আরেকবার বট বললে বস রাজকে বিচার দিবো 😡 🤖?",
    "আমাকে না ডেকে বস রাজকে ডাকো কাজে আসবো 🤖",
    "বট বললে কিন্তু থাপ্পর খাবি আমার নাম বাবু~~~~"
  ];
